	...
	public static void main(String[] args) {
		...
		ActionListener restart = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				counter = 0;
				timerActive = true;
				JOptionPane.showMessageDialog(null, "Click the button as fast as you can for " + delay / 1000 + " seconds, click OK when you are ready to begin.");
				timer.restart();
			}
		};
		...
		ActionListener lastScore = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(last != null)
					...
					JOptionPane.showMessageDialog(null, "Click start and try clicking the big button first!");
			}
		};
