...
public class PlaneTest {
	...
	/* 
		...
		10.80
	*/
	 private static String test1 = "point 4.1 5.5 2.3 3.2 point 4.1 -5.5 2.3 3.2 point -4.1 5.5 2.3 3.2 point -4.1 -5.5 2.3 3.2 q"; //Correct
	 ...
	 /* 
		...
		8.32
	*/
	 private static String test2 = "triangle 4.3 6.7 1.2 4.5 1.2 6.7 triangle 4.3 5.7 1.2 4.5 1.2 6.7 triangle 3.3 6.7 0.2 4.5 1.2 6.7 q"; //Area of a triangle is screwed up
	 ...
	 /* 
		...
		21.20
	*/
	 private static String test3 = "rectangle 5.4 1.2 6.1 2.5 rectangle -5.4 1.2 1.4 9.2 q"; //Correct
	...
	/* 
		...
		32.00
	*/
	private static String test4 = "trapezoid 1.2 3.4 2.4 -3.4 5.1 5.1 trapezoid 1.3 4.8 2.5 1.3 10.3 6.8 trapezoid 1.3 4.8 2.5 -1.3 6.8 10.9 q"; //Correct
	...
	/* 
		...
		16.44
	*/
	private static String test5 = "trapezoid 4.4 4.8 2.2 1.3 9.7 5.4 trapezoid 4.4 4.8 2.2 1.3 3.4 5.4 q"; //Correct
	...
	/* 
		...
		-8.50 -5.60
	*/
	private static String test6 = "circle -8.5 -5.6 7.3 q"; //Correct
	...
	/* 
		...
		8.50 -9.81
	*/
	private static String test7 = "equiltri 8.5 -5.6 7.3 q"; //Again triangle area screwed up
	...
	/* 
		...
		-4.85 1.95
	*/
	private static String test8 = "square -8.5 5.6 7.3 q"; //Correct
	...
	/* 
		...
		Center of point of symmetries is null
	*/
	private static String test9 = "plane inputDone plane t 3.3 6.7 0.2 4.5 1.2 6.7 r 3.3 6.7 1.4 9.2 inputDone q"; //Incorrect area, just a square
	...
	/* 
		...
		0.00 -7.71
	*/
	private static String test10 = "plane c -8.5 -5.6 7.3 s 8.5 1.4 1.9 inputDone plane c -8.5 -5.6 7.3 t 3.3 6.7 0.2 4.5 1.2 6.7 tr 1.3 4.8 2.5 -1.3 6.8 10.9 tr 1.2 3.4 2.4 -3.4 5.1 5.1 e 8.5 -5.6 7.3 inputDone q"; //Incorrect second area and y-coor of point of symmetry
