...
# pyhop.declare_operators (op_craft_stick)
# pyhop.declare_operators (op_craft_plank)
# pyhop.declare_operators (op_punch_for_wood)
# pyhop.declare_operators (op_craft_bench)
# pyhop.declare_operators (op_craft_wooden_axe_at_bench)
# pyhop.declare_operators (op_wooden_axe_for_wood)
...
def craft_wooden_axe_at_bench (state, ID):
	return [('have_enough', ID, 'bench', 1), ('have_enough', ID, 'plank', 3), ('have_enough', ID, 'stick', 2), ('op_craft_wooden_axe_at_bench', ID)]
