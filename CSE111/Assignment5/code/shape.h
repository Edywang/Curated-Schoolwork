...
class shape {
   ...
   public:
      ...
      virtual ~shape() {}
      virtual void draw (const vertex&, const rgbcolor&, string num, bool border, const rgbcolor& bColor, GLfloat lineWidth) const = 0;
...
class text: public shape {
   ...
   public:
      ...
      virtual void draw (const vertex&, const rgbcolor&, string num, bool border, const rgbcolor& bColor, GLfloat lineWidth) const override;
