...
num_elements:   .word 5                       # change this to match
                                              # number of program args

test_int_array: .space 24                     # placeholder for int array
...
.data
sort_array_test:   .word 0xFFFFFFFF           # modify with test case
                   .word 0xFFFFFFFC
                   .word 0x00000000
                   
sort_array_length: .word 3                    # modify to correspond
                                              # with test case above
...
.data
print_decimal_test: .word 64                  # modify with sepcific
                                              # test case
...
.data
print_decimal_arr_test: .word 0xFFFFFFFC         # modify with specific
                        .word 0xFFFFFFFF         # test case
                        .word 0x00000002
                        .word 0x00000003
                        
print_decimal_arr_len:  .word 4                  # modify to correspond
                                                 # with test case above
                                                 # should match number of
                                                 # elements in
                                                 # print_decimal_arr_test
