...
def midpoint_displacement(start, end, roughness, vertical_displacement=None,
    ...
    # Data structure that stores the points as a list of lists where
    ...
    while iteration <= num_of_iterations:
        ...
        for i in range(len(points_tup)-1):
            ...
            # is preserved.
            # By default the maintained order is from smallest to biggest list by their first
...
def main():
    ...
    # print(layer_1) # Notice how the output is in brackets, we're looking at a list of lists, each list with two values, an x and y
